...
class PageSizeSchema(
    ...
    class MetaOapg:
        ...
        inclusive_minimum = 1
FileSchema = schemas.IntSchema
StageSchema = schemas.IntSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'file': typing.Union[FileSchema, decimal.Decimal, int, ],
        'stage': typing.Union[StageSchema, decimal.Decimal, int, ],
    },
    total=False
)
        ...
        class properties:
            ...
            class results(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['String']:
                        return String
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['String'], typing.List['String']],
