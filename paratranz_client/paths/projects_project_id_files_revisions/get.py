...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'file': typing.Union[FileSchema, decimal.Decimal, int, float, ],
        ...
        class properties:
            ...
            class results(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['Revision']:
                        return Revision
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['Revision'], typing.List['Revision']],
                ...
                def __getitem__(self, i: int) -> 'Revision':
...
class GetFileRevisions(BaseApi):
    ...
    def get_file_revisions(
        ...
        return self._get_file_revisions_oapg(
