...
# body param
SchemaForRequestBodyApplicationJson = Issue


request_body_issue = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _save_issue_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_issue.serialize(body, content_type)
