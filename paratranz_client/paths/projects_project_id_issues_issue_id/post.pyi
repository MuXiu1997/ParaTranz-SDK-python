...
IssueIdSchema = schemas.IntSchema
# body param
...
class SchemaForRequestBodyApplicationJson(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["op", "content", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["op", "content", ], str]):
...
SchemaFor201ResponseBodyApplicationJson = Reply
...
class OperateIssue(BaseApi):
    ...
    def operate_issue(
        ...
        return self._operate_issue_oapg(
            body=body,
