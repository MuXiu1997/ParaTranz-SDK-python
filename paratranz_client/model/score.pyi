...
class Score(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            def uid() -> typing.Type['UserId']:
                return UserId
            base = schemas.IntSchema
            multiplier = schemas.IntSchema
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "createdAt", "project", "uid", "base", "multiplier", "value", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "createdAt", "project", "uid", "base", "multiplier", "value", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, ],
        ...
        base: typing.Union[MetaOapg.properties.base, decimal.Decimal, int, schemas.Unset] = schemas.unset,
