...
class String(
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["stage"]) -> 'Stage': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "createdAt", "updatedAt", "key", "original", "translation", "file", "stage", "project", "uid", "context", "words", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["stage"]) -> typing.Union['Stage', schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "createdAt", "updatedAt", "key", "original", "translation", "file", "stage", "project", "uid", "context", "words", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        stage: typing.Union['Stage', schemas.Unset] = schemas.unset,
