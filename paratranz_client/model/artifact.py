...
class Artifact(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "createdAt", "project", "total", "translated", "disputed", "reviewed", "hidden", "duration", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "createdAt", "project", "total", "translated", "disputed", "reviewed", "hidden", "duration", ], str]):
