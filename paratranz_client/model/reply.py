...
class Reply(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "createdAt", "updatedAt", "project", "uid", "parent", "content", "html", "lastEdit", "refer", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "createdAt", "updatedAt", "project", "uid", "parent", "content", "html", "lastEdit", "refer", ], str]):
