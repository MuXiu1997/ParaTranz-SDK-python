...
class Project(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "createdAt", "updatedAt", "uid", "name", "logo", "desc", "source", "dest", "members", "game", "license", "activeLevel", "stage", "privacy", "download", "issueMode", "reviewMode", "joinMode"]
