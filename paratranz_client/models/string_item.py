...
class StringItem(BaseModel):
    ...
    file: Optional[StrictInt] = Field(default=None, description="词条所属的文件ID")
    ...
    __properties: ClassVar[List[str]] = ["id", "createdAt", "updatedAt", "key", "original", "translation", "file", "stage", "project", "uid", "context", "words"]
